			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="city" name="city" class="form-control" value="'.$row["address1"].'" pattern="^[a-zA-Z ]+$" required>
						
						<label for="city"><i class="fa fa-institution"></i> City</label>
						<input type="text" id="adr" name="address" class="form-control" value="'.$row["address2"].'" required>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Delivering address same as billing
					</label>';
					$i=1;
					$total=0;
			...
			<div class="col-25">
				...
				if (isset($_POST["cmd"])) {
					...
					while($i<=$total_count){
						...
						<tr><td><p><b>$item_number_</b></p></td><td><p>$item_name_</p></td><td ><p>$quantity_</p></td><td ><p>Rs:$amount_</p></td></tr>";
