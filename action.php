	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
            ...
            echo '<div class="cart-summary">
				    <small class="qty" style="color:#00b6df; font-weight:bolder;">'.$n.' Item(s) selected</small>
				    <h5 style="color:#FFFFFF; font-weight:bolder;">Rs: '.$total_price.'</h5>
				</div>'
            ?>
    ...
    if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
	               ...
	               <table id="cart" class="table table-hover table-condensed" id=""  style="box-shadow: 15px 15px 25px 15px #07d3ee;">
    				<thead>
						<tr>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<h4 class="nomargin product-name header-cart-item-name"><a href="product.php?p='.$product_id.'"><b>'.$product_title.'</b></a></h4>
									</div>
									<div class="col-sm-6">
										<div style="max-width=50px;">
										<p><b>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</b></p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="updateproduct ">Ready to Checkout</a></td>
								</tr>
							</tfoot>
